...
- Replay uses coordinates with live readers. Replay consumes the recorded FrameInput order exactly and does not sort it again; live-input and transfer publication ordering is supplied by the engine-owned managers.
