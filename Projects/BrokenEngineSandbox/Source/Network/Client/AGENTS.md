...
- Player-event, timespeed, and fleet-sync handlers have independent log-and-continue exception boundaries. Static-data application and per-frame gameplay hydration remain outside those catches.
