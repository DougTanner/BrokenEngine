...
- New trails briefly suppress length until movement establishes a segment. Trail identity is client-local and never crosses a cell boundary, so a transferred missile always starts a fresh trail and takes that suppression again.
