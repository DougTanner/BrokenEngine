...
public:
	...
	// Socket/bind/listen failures make Main fail fast instead of leaving an uncontrollable agent-launched
	// process. The ctor logs the concrete WSA error before throwing std::runtime_error. An
