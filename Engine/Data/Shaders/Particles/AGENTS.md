...
Long and Square particles share spawn and update compute shaders but use separate storage, spawn buffers, and render vertex paths. They are client-only visual effects with no CPU readback; ParticleManager (`../../../Source/Graphics/Managers/AGENTS.md#particlemanager`) stages spawns and owns GPU resources.
